 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var sI;function ck(){return sI||(sI=1,(function(e){function t(L,Y){var V=L.length;L.push(Y);e:for(;0<V;){var H=V-1>>>1,F=L[H];if(0<a(F,Y))L[H]=Y,L[V]=F,V=H;else break e}}function n(L){return L.length===0?null:L[0]}function r(L){if(L.length===0)return null;var Y=L[0],V=L.pop();if(V!==Y){L[0]=V;e:for(var H=0,F=L.length,J=F>>>1;H<J;){var ue=2*(H+1)-1,he=L[ue],ge=ue+1,ye=L[ge];if(0>a(he,V))ge<F&&0>a(ye,he)?(L[H]=ye,L[ge]=V,H=ge):(L[H]=he,L[ue]=V,H=ue);else if(ge<F&&0>a(ye,V))L[H]=ye,L[ge]=V,H=ge;else break e}}return Y}function a(L,Y){var V=L.sortIndex-Y.sortIndex;return V!==0?V:L.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var s=Date,l=s.now();e.unstable_now=function(){return s.now()-l}}var c=[],f=[],h=1,d=null,v=3,y=!1,x=!1,I=!1,b=typeof setTimeout=="function"?setTimeout:null,S=typeof clearTimeout=="function"?clearTimeout:null,W=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function A(L){for(var Y=n(f);Y!==null;){if(Y.callback===null)r(f);else if(Y.startTime<=L)r(f),Y.sortIndex=Y.expirationTime,t(c,Y);else break;Y=n(f)}}function O(L){if(I=!1,A(L),!x)if(n(c)!==null)x=!0,K(w);else{var Y=n(f);Y!==null&&Q(O,Y.startTime-L)}}function w(L,Y){x=!1,I&&(I=!1,S(P),P=-1),y=!0;var V=v;try{for(A(Y),d=n(c);d!==null&&(!(d.expirationTime>Y)||L&&!j());){var H=d.callback;if(typeof H=="function"){d.callback=null,v=d.priorityLevel;var F=H(d.expirationTime<=Y);Y=e.unstable_now(),typeof F=="function"?d.callback=F:d===n(c)&&r(c),A(Y)}else r(c);d=n(c)}if(d!==null)var J=!0;else{var ue=n(f);ue!==null&&Q(O,ue.startTime-Y),J=!1}return J}finally{d=null,v=V,y=!1}}var _=!1,N=null,P=-1,C=5,T=-1;function j(){return!(e.unstable_now()-T<C)}function E(){if(N!==null){var L=e.unstable_now();T=L;var Y=!0;try{Y=N(!0,L)}finally{Y?$():(_=!1,N=null)}}else _=!1}var $;if(typeof W=="function")$=function(){W(E)};else if(typeof MessageChannel<"u"){var U=new MessageChannel,q=U.port2;U.port1.onmessage=E,$=function(){q.postMessage(null)}}else $=function(){b(E,0)};function K(L){N=L,_||(_=!0,$())}function Q(L,Y){P=b(function(){L(e.unstable_now())},Y)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(L){L.callback=null},e.unstable_continueExecution=function(){x||y||(x=!0,K(w))},e.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):C=0<L?Math.floor(1e3/L):5},e.unstable_getCurrentPriorityLevel=function(){return v},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function(L){switch(v){case 1:case 2:case 3:var Y=3;break;default:Y=v}var V=v;v=Y;try{return L()}finally{v=V}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(L,Y){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var V=v;v=L;try{return Y()}finally{v=V}},e.unstable_scheduleCallback=function(L,Y,V){var H=e.unstable_now();switch(typeof V=="object"&&V!==null?(V=V.delay,V=typeof V=="number"&&0<V?H+V:H):V=H,L){case 1:var F=-1;break;case 2:F=250;break;case 5:F=1073741823;break;case 4:F=1e4;break;default:F=5e3}return F=V+F,L={id:h++,callback:Y,priorityLevel:L,startTime:V,expirationTime:F,sortIndex:-1},V>H?(L.sortIndex=V,t(f,L),n(c)===null&&L===n(f)&&(I?(S(P),P=-1):I=!0,Q(O,V-H))):(L.sortIndex=F,t(c,L),x||y||(x=!0,K(w))),L},e.unstable_shouldYield=j,e.unstable_wrapCallback=function(L){var Y=v;return function(){var V=v;v=Y;try{return L.apply(this,arguments)}finally{v=V}}}})(yf)),yf}var lI;function fk(){return lI||(lI=1,gf.exports=ck()),gf.exports}/**
 * @license React
...
Inapp,2026-05-10,,,,Bot
Webapp,2026-05-10,,,,Bot
Inapp,2026-05-10,,,,Bot`;function CY(){const[e,t]=X.useState([]),[n,r]=X.useState([]),[a,i]=X.useState("all"),[s,l]=X.useState("all"),[c,f]=X.useState([]),[h,d]=X.useState("overview"),[v,y]=X.useState(null),x=X.useRef(null),[I,b]=X.useState(null),S=X.useRef([]);X.useEffect(()=>{S.current=e},[e]);const W=$=>{if(!$)return $;const U=$.trim(),q=U.match(/^(\d{4})[-\/](\d{1,2})[-\/](\d{1,2})$/);if(q){const[,L,Y,V]=q;return`${V.padStart(2,"0")}-${Y.padStart(2,"0")}-${L}`}const K=U.match(/^(\d{1,2})[-\/](\d{1,2})[-\/](\d{4})$/);if(K){const[,L,Y,V]=K;return parseInt(L)>12?`${L.padStart(2,"0")}-${Y.padStart(2,"0")}-${V}`:`${Y.padStart(2,"0")}-${L.padStart(2,"0")}-${V}`}const Q=new Date(U);return isNaN(Q.getTime())?U:`${String(Q.getDate()).padStart(2,"0")}-${String(Q.getMonth()+1).padStart(2,"0")}-${Q.getFullYear()}`};X.useEffect(()=>{let $=[];hI.parse(OY,{header:!0,skipEmptyLines:!0,complete:async U=>{$=U.data.map(q=>({channel:q.Channel||q.channel||"",createdAt:W(q["Created at"]||q.createdAt||q["Created date"]||q.Date||q.date||q["Created Date"]||""),product:q.Product||q.product||"",issue:q.Issue||q.issue||"",subType:q["Sub Type"]||q.subType||"",handled:q.Handled||q.handled||""}));try{const q=localStorage.getItem("waggle_manual_data");let K=await N3();if(q&&K.length===0)try{const Q=JSON.parse(q);Array.isArray(Q)&&(K=Q,await k3(Q))}catch{}Array.isArray(K)&&K.length>0&&($=[...$,...K])}catch(q){console.error("Error loading data from IndexedDB",q)}t($)}})},[]);const A=X.useMemo(()=>{const $=["january","february","march","april","may","june","july","august","september","october","november","december"],U=new Set;return e.forEach(q=>{try{const K=ir(q.createdAt);if(!isNaN(K.getTime())){const Q=$[K.getMonth()];U.add(`${Q}-${K.getFullYear()}`)}}catch{}}),Array.from(U).sort((q,K)=>{const[Q,L]=q.split("-"),[Y,V]=K.split("-");return L!==V?parseInt(L)-parseInt(V):$.indexOf(Q)-$.indexOf(Y)})},[e]);X.useEffect(()=>{f(a&&a!=="all"?AW(a):[]),l("all")},[a]),X.useEffect(()=>{e.length>0&&w(a,s)},[s,a,e,h]);const O=$=>{var q;const U=(q=$.target.files)==null?void 0:q[0];U&&(hI.parse(U,{header:!0,skipEmptyLines:!0,complete:K=>{if(!K.data.length){b({type:"error",message:"The CSV file appears to be empty."});return}const Q=K.data.map(V=>({channel:V.Channel||V.channel||"",createdAt:W(V["Created at"]||V.createdAt||V["Created date"]||V.Date||V.date||V["Created Date"]||""),product:V.Product||V.product||"",issue:V.Issue||V.issue||"",subType:V["Sub Type"]||V.subType||"",handled:V.Handled||V.handled||""})),L=new Set(S.current.map(V=>`${V.channel}|${V.createdAt}|${V.product}|${V.issue}|${V.subType}|${V.handled}`)),Y=Q.filter(V=>!L.has(`${V.channel}|${V.createdAt}|${V.product}|${V.issue}|${V.subType}|${V.handled}`));Y.length>0?N3().then(async V=>{const H=[...V,...Y];await k3(H);try{localStorage.setItem("waggle_manual_data",JSON.stringify(H))}catch{}t(F=>[...F,...Y]),b({type:"success",message:`Added ${Y.length} rows.`}),setTimeout(()=>b(null),5e3)}).catch(V=>{console.error("Failed to save manual data",V),b({type:"error",message:"Failed to save data. Try again."}),setTimeout(()=>b(null),5e3)}):(b({type:"error",message:"No new rows found."}),setTimeout(()=>b(null),5e3))}}),$.target.value="")},w=($,U,q)=>{let K=e;if($!=="all"?K=e.filter(Q=>{const L=ir(Q.createdAt);return Ev(L,$)}):K=e.filter(Q=>!isNaN(ir(Q.createdAt).getTime())),U!=="all"){const Q=c.find(L=>L.value===U);Q&&(K=K.filter(L=>_W(ir(L.createdAt),Q)))}r(K)},_=Tv(n),N=Rv(n),P=MW(n),C=lR(n),T=sR(e,a),j=[{from:"from-blue-500",to:"to-cyan-500"},{from:"from-purple-500",to:"to-indigo-600"},{from:"from-pink-500",to:"to-rose-600"},{from:"from-emerald-500",to:"to-teal-600"},{from:"from-orange-500",to:"to-amber-500"}],E=(a==="all"?A:[a]).map(($,U)=>{const q=e.filter(Y=>Ev(ir(Y.createdAt),$)),[K,Q]=$.split("-"),L=j[U%j.length];return{name:`${K.charAt(0).toUpperCase()+K.slice(1)} ${Q}`,shortName:`Month ${U+1}`,data:q,metrics:Tv(q),channels:Rv(q),colorFrom:L.from,colorTo:L.to}});return M.jsx("div",{className:"min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8",children:M.jsxs("div",{className:"max-w-7xl mx-auto space-y-6",children:[M.jsxs("div",{className:"flex flex-col md:flex-row md:items-center md:justify-between gap-4",children:[M.jsxs("div",{children:[M.jsxs("h1",{className:"text-3xl font-bold",children:["Waggle AI Chatbot Dashboard ",M.jsx("span",{className:"text-xs font-normal text-gray-400 align-top",children:"v1.3"})]}),M.jsx("p",{className:"text-gray-600 mt-1",children:"Track and analyze customer support interactions"})]}),M.jsxs("div",{className:"flex flex-col sm:flex-row gap-3",children:[M.jsxs("select",{value:a,onChange:$=>i($.target.value),className:"h-9 rounded-md border border-gray-300 bg-white px-3 py-1 text-sm shadow-sm w-full sm:w-[200px]",children:[M.jsx("option",{value:"all",children:"All Months"}),A.map($=>M.jsxs("option",{value:$,children:[$.split("-")[0].charAt(0).toUpperCase()+$.split("-")[0].slice(1)," ",$.split("-")[1]]},$))]}),M.jsxs("select",{value:s,onChange:$=>l($.target.value),className:"h-9 rounded-md border border-gray-300 bg-white px-3 py-1 text-sm shadow-sm w-full sm:w-[200px]",disabled:a==="all",children:[M.jsx("option",{value:"all",children:"All Weeks"}),c.map($=>M.jsx("option",{value:$.value,children:$.label},$.value))]}),M.jsx("input",{ref:x,type:"file",accept:".csv",onChange:O,className:"hidden"}),M.jsxs(xI,{onClick:()=>{var $;return($=x.current)==null?void 0:$.click()},variant:"outline",className:"bg-white border-blue-300 text-blue-700",children:[M.jsx(QN,{className:"w-4 h-4 mr-2"})," Add Data"]}),M.jsxs(xI,{onClick:()=>pR(n),variant:"outline",className:"bg-white",children:[M.jsx(XN,{className:"w-4 h-4 mr-2"})," Export CSV"]})]})]}),I&&M.jsx(zn,{className:`border ${I.type==="success"?"bg-green-50":"bg-red-50"}`,children:M.jsxs(Un,{className:"p-4 flex items-center justify-between",children:[M.jsx("p",{className:"font-medium",children:I.message}),M.jsx("button",{onClick:()=>b(null),children:M.jsx(oE,{className:"w-4 h-4"})})]})}),a==="all"&&M.jsx("div",{className:"flex justify-center",children:M.jsxs("div",{className:"inline-flex rounded-lg border border-gray-200 bg-white p-1",children:[M.jsx("button",{onClick:()=>d("overview"),className:`px-6 py-2 rounded-md text-sm font-medium ${h==="overview"?"bg-blue-600 text-white":"text-gray-700"}`,children:"Overview Comparison"}),M.jsx("button",{onClick:()=>d("detailed"),className:`px-6 py-2 rounded-md text-sm font-medium ${h==="detailed"?"bg-blue-600 text-white":"text-gray-700"}`,children:"Detailed Analysis"})]})}),a==="all"&&h==="overview"?M.jsx(AY,{monthsData:E,weeklyEscalation:T}):M.jsxs(M.Fragment,{children:[M.jsx(cR,{metrics:_}),M.jsx(sO,{metrics:_,topChannel:N[0],top5Products:P.slice(0,5),top5Issues:Hv(n,5),monthCount:a==="all"?A.length:1}),M.jsx(rO,{data:T,instanceId:"detailed-analysis"}),M.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[M.jsx(aO,{data:N}),M.jsx(PY,{data:P})]}),M.jsx(zn,{children:M.jsx(Un,{className:"p-6",children:M.jsxs(EN,{defaultValue:"issues",className:"w-full",children:[M.jsxs(TN,{className:"grid w-full grid-cols-2 max-w-md",children:[M.jsx(wI,{value:"issues",children:"Issue Analysis"}),M.jsx(wI,{value:"sessions",children:"Detailed Sessions"})]}),M.jsx(PI,{value:"issues",className:"mt-6",children:M.jsx(SY,{data:C})}),M.jsx(PI,{value:"sessions",className:"mt-6",children:M.jsx(WY,{data:n})})]})})})]})]})})}mk.createRoot(document.getElementById("root")).render(M.jsx(CY,{}));
