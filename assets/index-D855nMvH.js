 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var lI;function cH(){return lI||(lI=1,(function(e){function n(j,Q){var X=j.length;j.push(Q);e:for(;0<X;){var R=X-1>>>1,F=j[R];if(0<a(F,Q))j[R]=Q,j[X]=F,X=R;else break e}}function t(j){return j.length===0?null:j[0]}function r(j){if(j.length===0)return null;var Q=j[0],X=j.pop();if(X!==Q){j[0]=X;e:for(var R=0,F=j.length,J=F>>>1;R<J;){var ue=2*(R+1)-1,me=j[ue],ge=ue+1,ye=j[ge];if(0>a(me,X))ge<F&&0>a(ye,me)?(j[R]=ye,j[ge]=X,R=ge):(j[R]=me,j[ue]=X,R=ue);else if(ge<F&&0>a(ye,X))j[R]=ye,j[ge]=X,R=ge;else break e}}return Q}function a(j,Q){var X=j.sortIndex-Q.sortIndex;return X!==0?X:j.id-Q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var p=Date,s=p.now();e.unstable_now=function(){return p.now()-s}}var c=[],f=[],m=1,d=null,v=3,y=!1,B=!1,I=!1,b=typeof setTimeout=="function"?setTimeout:null,W=typeof clearTimeout=="function"?clearTimeout:null,S=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function M(j){for(var Q=t(f);Q!==null;){if(Q.callback===null)r(f);else if(Q.startTime<=j)r(f),Q.sortIndex=Q.expirationTime,n(c,Q);else break;Q=t(f)}}function O(j){if(I=!1,M(j),!B)if(t(c)!==null)B=!0,U(P);else{var Q=t(f);Q!==null&&V(O,Q.startTime-j)}}function P(j,Q){B=!1,I&&(I=!1,W(w),w=-1),y=!0;var X=v;try{for(M(Q),d=t(c);d!==null&&(!(d.expirationTime>Q)||j&&!D());){var R=d.callback;if(typeof R=="function"){d.callback=null,v=d.priorityLevel;var F=R(d.expirationTime<=Q);Q=e.unstable_now(),typeof F=="function"?d.callback=F:d===t(c)&&r(c),M(Q)}else r(c);d=t(c)}if(d!==null)var J=!0;else{var ue=t(f);ue!==null&&V(O,ue.startTime-Q),J=!1}return J}finally{d=null,v=X,y=!1}}var A=!1,N=null,w=-1,H=5,T=-1;function D(){return!(e.unstable_now()-T<H)}function k(){if(N!==null){var j=e.unstable_now();T=j;var Q=!0;try{Q=N(!0,j)}finally{Q?q():(A=!1,N=null)}}else A=!1}var q;if(typeof S=="function")q=function(){S(k)};else if(typeof MessageChannel<"u"){var L=new MessageChannel,K=L.port2;L.port1.onmessage=k,q=function(){K.postMessage(null)}}else q=function(){b(k,0)};function U(j){N=j,A||(A=!0,q())}function V(j,Q){w=b(function(){j(e.unstable_now())},Q)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(j){j.callback=null},e.unstable_continueExecution=function(){B||y||(B=!0,U(P))},e.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):H=0<j?Math.floor(1e3/j):5},e.unstable_getCurrentPriorityLevel=function(){return v},e.unstable_getFirstCallbackNode=function(){return t(c)},e.unstable_next=function(j){switch(v){case 1:case 2:case 3:var Q=3;break;default:Q=v}var X=v;v=Q;try{return j()}finally{v=X}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(j,Q){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var X=v;v=j;try{return Q()}finally{v=X}},e.unstable_scheduleCallback=function(j,Q,X){var R=e.unstable_now();switch(typeof X=="object"&&X!==null?(X=X.delay,X=typeof X=="number"&&0<X?R+X:R):X=R,j){case 1:var F=-1;break;case 2:F=250;break;case 5:F=1073741823;break;case 4:F=1e4;break;default:F=5e3}return F=X+F,j={id:m++,callback:Q,priorityLevel:j,startTime:X,expirationTime:F,sortIndex:-1},X>R?(j.sortIndex=X,n(f,j),t(c)===null&&j===t(f)&&(I?(W(w),w=-1):I=!0,V(O,X-R))):(j.sortIndex=F,n(c,j),B||y||(B=!0,U(P))),j},e.unstable_shouldYield=D,e.unstable_wrapCallback=function(j){var Q=v;return function(){var X=v;v=Q;try{return j.apply(this,arguments)}finally{v=X}}}})(yf)),yf}var cI;function fH(){return cI||(cI=1,gf.exports=cH()),gf.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jC=Y.forwardRef(({color:e="currentColor",size:n=24,strokeWidth:t=2,absoluteStrokeWidth:r,className:a="",children:i,iconNode:p,...s},c)=>Y.createElement("svg",{ref:c,...DC,width:n,height:n,stroke:e,strokeWidth:r?Number(t)*24/Number(n):t,className:m3("lucide",a),...s},[...p.map(([f,m])=>Y.createElement(f,m)),...Array.isArray(i)?i:[i]]));/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qt=(e,n)=>{const t=Y.forwardRef(({className:r,...a},i)=>Y.createElement(jC,{ref:i,iconNode:n,className:m3(`lucide-${TC(SI(e))}`,`lucide-${e}`,r),...a}));return t.displayName=SI(e),t};/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function pF(e,n){if(e){if(typeof e=="string")return Bg(e,n);var t=Object.prototype.toString.call(e).slice(8,-1);if(t==="Object"&&e.constructor&&(t=e.constructor.name),t==="Map"||t==="Set")return Array.from(e);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return Bg(e,n)}}function sF(e){if(typeof Symbol<"u"&&e[Symbol.iterator]!=null||e["@@iterator"]!=null)return Array.from(e)}function lF(e){if(Array.isArray(e))return Bg(e)}function Bg(e,n){(n==null||n>e.length)&&(n=e.length);for(var t=0,r=new Array(n);t<n;t++)r[t]=e[t];return r}function p0(){return p0=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r])}return e},p0.apply(this,arguments)}function C4(e,n){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);n&&(r=r.filter(function(a){return Object.getOwnPropertyDescriptor(e,a).enumerable})),t.push.apply(t,r)}return t}function N4(e){for(var n=1;n<arguments.length;n++){var t=arguments[n]!=null?arguments[n]:{};n%2?C4(Object(t),!0).forEach(function(r){cF(e,r,t[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):C4(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r))})}return e}function cF(e,n,t){return n=fF(n),n in e?Object.defineProperty(e,n,{value:t,enumerable:!0,configurable:!0,writable:!0}):e[n]=t,e}function fF(e){var n=dF(e,"string");return Cp(n)=="symbol"?n:n+""}function dF(e,n){if(Cp(e)!="object"||!e)return e;var t=e[Symbol.toPrimitive];if(t!==void 0){var r=t.call(e,n);if(Cp(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(e)}function R4(e,n){if(e==null)return{};var t=mF(e,n),r,a;if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(e);for(a=0;a<i.length;a++)r=i[a],!(n.indexOf(r)>=0)&&Object.prototype.propertyIsEnumerable.call(e,r)&&(t[r]=e[r])}return t}function mF(e,n){if(e==null)return{};var t={};for(var r in e)if(Object.prototype.hasOwnProperty.call(e,r)){if(n.indexOf(r)>=0)continue;t[r]=e[r]}return t}var hF=function(n){return Array.isArray(n.value)?rF(n.value):n.value};function lr(e){var n=e.valueAccessor,t=n===void 0?hF:n,r=R4(e,aF),a=r.data,i=r.dataKey,p=r.clockWise,s=r.id,c=r.textBreakAll,f=R4(r,oF);return!a||!a.length?null:E.createElement(je,{className:"recharts-label-list"},a.map(function(m,d){var v=Ne(i)?t(m,d):ln(m&&m.payload,i),y=Ne(s)?{}:{id:"".concat(s,"-").concat(d)};return E.createElement(zn,p0({},Se(m,!0),f,y,{parentViewBox:m.parentViewBox,value:v,textBreakAll:c,viewBox:zn.parseViewBox(Ne(p)?m:N4(N4({},m),{},{clockWise:p})),key:"label-".concat(d),index:d}))}))}lr.displayName="LabelList";function vF(e,n){return e?e===!0?E.createElement(lr,{key:"labelList-implicit",data:n}):E.isValidElement(e)||Ce(e)?E.createElement(lr,{key:"labelList-implicit",data:n,content:e}):Qi(e)?E.createElement(lr,p0({data:n},e,{key:"labelList-implicit"})):null:null}function gF(e,n){var t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:!0;if(!e||!e.children&&t&&!e.label)return null;var r=e.children,a=pt(r,lr).map(function(p,s){return Y.cloneElement(p,{data:n,key:"labelList-".concat(s)})});if(!t)return a;var i=vF(e.label,n);return[i].concat(iF(a))}lr.renderCallByParent=gF;function Np(e){"@babel/helpers - typeof";return Np=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(n){return typeof n}:function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},Np(e)}function xg(){return xg=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r])}return e},xg.apply(this,arguments)}function k4(e,n){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);n&&(r=r.filter(function(a){return Object.getOwnPropertyDescriptor(e,a).enumerable})),t.push.apply(t,r)}return t}function T4(e){for(var n=1;n<arguments.length;n++){var t=arguments[n]!=null?arguments[n]:{};n%2?k4(Object(t),!0).forEach(function(r){yF(e,r,t[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):k4(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r))})}return e}function yF(e,n,t){return n=bF(n),n in e?Object.defineProperty(e,n,{value:t,enumerable:!0,configurable:!0,writable:!0}):e[n]=t,e}function bF(e){var n=IF(e,"string");return Np(n)=="symbol"?n:n+""}function IF(e,n){if(Np(e)!="object"||!e)return e;var t=e[Symbol.toPrimitive];if(t!==void 0){var r=t.call(e,n);if(Np(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(e)}var BF=function(n,t){var r=ot(t-n),a=Math.min(Math.abs(t-n),359.999);return r*a},Pl=function(n){var t=n.cx,r=n.cy,a=n.radius,i=n.angle,p=n.sign,s=n.isExternal,c=n.cornerRadius,f=n.cornerIsExternal,m=c*(s?1:-1)+a,d=Math.asin(c/m)/u0,v=f?i:i+p*d,y=on(t,r,m,v),B=on(t,r,a,v),I=f?i-p*d:i,b=on(t,r,m*Math.cos(d*u0),I);return{center:y,circleTangency:B,lineTangency:b,theta:d}},UM=function(n){var t=n.cx,r=n.cy,a=n.innerRadius,i=n.outerRadius,p=n.startAngle,s=n.endAngle,c=BF(p,s),f=p+c,m=on(t,r,i,p),d=on(t,r,i,f),v="M ".concat(m.x,",").concat(m.y,`
  ...
  `);if(a>0){var A=Pl({cx:t,cy:r,radius:a,angle:f,sign:d,isExternal:!0,cornerRadius:p,cornerIsExternal:c}),N=A.circleTangency,w=A.lineTangency,H=A.theta,T=Pl({cx:t,cy:r,radius:a,angle:m,sign:-d,isExternal:!0,cornerRadius:p,cornerIsExternal:c}),D=T.circleTangency,k=T.lineTangency,q=T.theta,L=c?Math.abs(f-m):Math.abs(f-m)-H-q;if(L<0&&p===0)return"".concat(P,"L").concat(t,",").concat(r,"Z");P+="L".concat(k.x,",").concat(k.y,`
...
Inapp,2026-05-31,,,,Bot
Inapp,2026-05-31,,,,Bot
`;function RY(){const[e,n]=Y.useState([]),[t,r]=Y.useState([]),[a,i]=Y.useState("all"),[p,s]=Y.useState("all"),[c,f]=Y.useState([]),[m,d]=Y.useState("overview"),v=Y.useRef(null),[y,B]=Y.useState(null),[I,b]=Y.useState(!1),W=Y.useRef([]);Y.useEffect(()=>{W.current=e},[e]);const S=L=>{if(!L)return L;const K=L.trim(),U=K.match(/^(\d{4})[-\/](\d{1,2})[-\/](\d{1,2})$/);if(U){const[,Q,X,R]=U;return`${R.padStart(2,"0")}-${X.padStart(2,"0")}-${Q}`}const V=K.match(/^(\d{1,2})[-\/](\d{1,2})[-\/](\d{4})$/);if(V){const[,Q,X,R]=V;return parseInt(Q)>12?`${Q.padStart(2,"0")}-${X.padStart(2,"0")}-${R}`:`${X.padStart(2,"0")}-${Q.padStart(2,"0")}-${R}`}const j=new Date(K);return isNaN(j.getTime())?K:`${String(j.getDate()).padStart(2,"0")}-${String(j.getMonth()+1).padStart(2,"0")}-${j.getFullYear()}`};Y.useEffect(()=>{let L=[];vI.parse(NY,{header:!0,skipEmptyLines:!0,complete:async K=>{L=K.data.map(U=>({channel:U.Channel||U.channel||"",createdAt:S(U["Created at"]||U.createdAt||U["Created date"]||U.Date||U.date||U["Created Date"]||""),product:U.Product||U.product||"",issue:U.Issue||U.issue||"",subType:U["Sub Type"]||U.subType||"",handled:U.Handled||U.handled||""}));try{const U=localStorage.getItem("waggle_manual_data");let V=await RW();if(U&&V.length===0)try{const j=JSON.parse(U);Array.isArray(j)&&(V=j,await NW(j))}catch{}Array.isArray(V)&&V.length>0&&(L=[...L,...V],b(!0))}catch(U){console.error("Error loading data from IndexedDB",U)}n(L)}})},[]);const M=Y.useMemo(()=>{const L=["january","february","march","april","may","june","july","august","september","october","november","december"],K=new Set;return e.forEach(U=>{try{const V=ur(U.createdAt);if(!isNaN(V.getTime())){const j=L[V.getMonth()];K.add(`${j}-${V.getFullYear()}`)}}catch{}}),Array.from(K).sort((U,V)=>{const[j,Q]=U.split("-"),[X,R]=V.split("-");return Q!==R?parseInt(Q)-parseInt(R):L.indexOf(j)-L.indexOf(X)})},[e]);Y.useEffect(()=>{f(a&&a!=="all"?A3(a):[]),s("all")},[a]),Y.useEffect(()=>{e.length>0&&A(a,p)},[p,a,e,m]);const O=L=>{var U;const K=(U=L.target.files)==null?void 0:U[0];K&&(vI.parse(K,{header:!0,skipEmptyLines:!0,complete:V=>{if(!V.data.length){B({type:"error",message:"The CSV file appears to be empty."});return}const j=V.data.map(R=>({channel:R.Channel||R.channel||"",createdAt:S(R["Created at"]||R.createdAt||R["Created date"]||R.Date||R.date||R["Created Date"]||""),product:R.Product||R.product||"",issue:R.Issue||R.issue||"",subType:R["Sub Type"]||R.subType||"",handled:R.Handled||R.handled||""})),Q=new Set(W.current.map(R=>`${R.channel}|${R.createdAt}|${R.product}|${R.issue}|${R.subType}|${R.handled}`)),X=j.filter(R=>!Q.has(`${R.channel}|${R.createdAt}|${R.product}|${R.issue}|${R.subType}|${R.handled}`));X.length>0?RW().then(async R=>{const F=[...R,...X];await NW(F);try{localStorage.setItem("waggle_manual_data",JSON.stringify(F))}catch{}n(J=>[...J,...X]),b(!0),B({type:"success",message:`Added ${X.length} rows.`}),setTimeout(()=>B(null),5e3)}).catch(R=>{console.error("Failed to save manual data",R),B({type:"error",message:"Failed to save data. Try again."}),setTimeout(()=>B(null),5e3)}):(B({type:"error",message:"No new rows found."}),setTimeout(()=>B(null),5e3))}}),L.target.value="")},P=async()=>{if(confirm("Are you sure you want to remove all manually uploaded data? This cannot be undone."))try{await CY(),localStorage.removeItem("waggle_manual_data"),b(!1),B({type:"success",message:"All uploaded data has been cleared. Reloading..."}),setTimeout(()=>window.location.reload(),1500)}catch(L){console.error("Failed to clear manual data",L),B({type:"error",message:"Failed to clear data."})}},A=(L,K,U)=>{let V=e;if(L!=="all"?V=e.filter(j=>{const Q=ur(j.createdAt);return kv(Q,L)}):V=e.filter(j=>!isNaN(ur(j.createdAt).getTime())),K!=="all"){const j=c.find(Q=>Q.value===K);j&&(V=V.filter(Q=>_3(ur(Q.createdAt),j)))}r(V)},N=Tv(t),w=Ev(t),H=O3(t),T=ck(t),D=lk(e,a),k=[{from:"from-blue-500",to:"to-cyan-500"},{from:"from-purple-500",to:"to-indigo-600"},{from:"from-pink-500",to:"to-rose-600"},{from:"from-emerald-500",to:"to-teal-600"},{from:"from-orange-500",to:"to-amber-500"}],q=(a==="all"?M:[a]).map((L,K)=>{const U=e.filter(X=>kv(ur(X.createdAt),L)),[V,j]=L.split("-"),Q=k[K%k.length];return{name:`${V.charAt(0).toUpperCase()+V.slice(1)} ${j}`,shortName:`Month ${K+1}`,data:U,metrics:Tv(U),channels:Ev(U),colorFrom:Q.from,colorTo:Q.to}});return _.jsx("div",{className:"min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8",children:_.jsxs("div",{className:"max-w-7xl mx-auto space-y-6",children:[_.jsxs("div",{className:"flex flex-col md:flex-row md:items-center md:justify-between gap-4",children:[_.jsxs("div",{children:[_.jsxs("h1",{className:"text-3xl font-bold",children:["Waggle AI Chatbot Dashboard ",_.jsx("span",{className:"text-xs font-normal text-gray-400 align-top",children:"v1.3"})]}),_.jsx("p",{className:"text-gray-600 mt-1",children:"Track and analyze customer support interactions"})]}),_.jsxs("div",{className:"flex flex-col sm:flex-row gap-3",children:[_.jsxs("select",{value:a,onChange:L=>i(L.target.value),className:"h-9 rounded-md border border-gray-300 bg-white px-3 py-1 text-sm shadow-sm w-full sm:w-[200px]",children:[_.jsx("option",{value:"all",children:"All Months"}),M.map(L=>_.jsxs("option",{value:L,children:[L.split("-")[0].charAt(0).toUpperCase()+L.split("-")[0].slice(1)," ",L.split("-")[1]]},L))]}),_.jsxs("select",{value:p,onChange:L=>s(L.target.value),className:"h-9 rounded-md border border-gray-300 bg-white px-3 py-1 text-sm shadow-sm w-full sm:w-[200px]",disabled:a==="all",children:[_.jsx("option",{value:"all",children:"All Weeks"}),c.map(L=>_.jsx("option",{value:L.value,children:L.label},L.value))]}),_.jsx("input",{ref:v,type:"file",accept:".csv",onChange:O,className:"hidden"}),I&&_.jsxs(Bf,{onClick:P,variant:"outline",className:"bg-white border-red-300 text-red-600",children:[_.jsx(JC,{className:"w-4 h-4 mr-2"})," Clear Uploads"]}),_.jsxs(Bf,{onClick:()=>{var L;return(L=v.current)==null?void 0:L.click()},variant:"outline",className:"bg-white border-blue-300 text-blue-700",children:[_.jsx(QC,{className:"w-4 h-4 mr-2"})," Add Data"]}),_.jsxs(Bf,{onClick:()=>fk(t),variant:"outline",className:"bg-white",children:[_.jsx(XC,{className:"w-4 h-4 mr-2"})," Export CSV"]})]})]}),y&&_.jsx(zt,{className:`border ${y.type==="success"?"bg-green-50":"bg-red-50"}`,children:_.jsxs(Ut,{className:"p-4 flex items-center justify-between",children:[_.jsx("p",{className:"font-medium",children:y.message}),_.jsx("button",{onClick:()=>B(null),children:_.jsx(uN,{className:"w-4 h-4"})})]})}),a==="all"&&_.jsx("div",{className:"flex justify-center",children:_.jsxs("div",{className:"inline-flex rounded-lg border border-gray-200 bg-white p-1",children:[_.jsx("button",{onClick:()=>d("overview"),className:`px-6 py-2 rounded-md text-sm font-medium ${m==="overview"?"bg-blue-600 text-white":"text-gray-700"}`,children:"Overview Comparison"}),_.jsx("button",{onClick:()=>d("detailed"),className:`px-6 py-2 rounded-md text-sm font-medium ${m==="detailed"?"bg-blue-600 text-white":"text-gray-700"}`,children:"Detailed Analysis"})]})}),a==="all"&&m==="overview"?_.jsx(_Y,{monthsData:q,weeklyEscalation:D}):_.jsxs(_.Fragment,{children:[_.jsx(dk,{metrics:N}),_.jsx(s_,{metrics:N,topChannel:w[0],top5Products:H.slice(0,5),top5Issues:Dv(t,5),monthCount:a==="all"?M.length:1}),_.jsx(a_,{data:D,instanceId:"detailed-analysis"}),_.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[_.jsx(o_,{data:w}),_.jsx(SY,{data:H})]}),_.jsx(zt,{children:_.jsx(Ut,{className:"p-6",children:_.jsxs(RC,{defaultValue:"issues",className:"w-full",children:[_.jsxs(kC,{className:"grid w-full grid-cols-2 max-w-md",children:[_.jsx(wI,{value:"issues",children:"Issue Analysis"}),_.jsx(wI,{value:"sessions",children:"Detailed Sessions"})]}),_.jsx(WI,{value:"issues",className:"mt-6",children:_.jsx(MY,{data:T})}),_.jsx(WI,{value:"sessions",className:"mt-6",children:_.jsx(AY,{data:t})})]})})})]})]})})}hH.createRoot(document.getElementById("root")).render(_.jsx(RY,{}));
